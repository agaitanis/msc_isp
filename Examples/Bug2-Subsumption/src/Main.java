...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BehaviorBasedAgent bug2 = new BehaviorBasedAgent(new Vector3d(0,0,8), "Bug0", 8, false);
        Sensors sensors = bug2.getSensors();
        Behavior[] behaviors = { new ReachGoal(sensors,bug2,goal),
            new CircumNavigate(sensors,bug2,goal,true),new MoveToGoal(sensors,bug2,goal) };
        boolean subsumes[][] = { { false, true,  true},
                                 { false, false, true},
                                 { false, false, false}};
        bug2.initBehaviors(behaviors, subsumes);
        environment.add(bug2);
