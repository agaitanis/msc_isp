...
import subsumption.subsumption.GoStraightAlways;
import subsumption.subsumption.ReachGoal;
import subsumption.subsumption.TurnLeft;
import subsumption.subsumption.TurnRight;
...
public class WallFollower {
   ...
   public void runMaze() {
      ...
      MazeEnvironmentDescription mazeEnvironmentDescription = new MazeEnvironmentDescription(
            new Maze(mazeRows));
      subsumption.BehaviorBasedAgent wallFollowingAgent = new subsumption.BehaviorBasedAgent(
   ...
   private void initBehaviorBasedAgent(
         subsumption.BehaviorBasedAgent behaviorBasedAgent) {
      subsumption.Sensors sensors = behaviorBasedAgent.getSensors();
      subsumption.Behavior[] behaviors = { new ReachGoal(sensors),
            new TurnLeft(sensors), new TurnRight(sensors),new GoStraightAlways(sensors)  };
