...
public class Main {
    ...
    static void spheres(EnvironmentDescription environment){
        ...
        environment.add(new MyRobot(new Vector3d(0,0,7),"my robot"));
    }      
    static void box(EnvironmentDescription environment){
        ...
        environment.add(new MyRobot(new Vector3d(0,0,6.5),"my robot"));
    }      
    ...
    static void spiral(EnvironmentDescription environment){
        ...
        environment.add(new MyRobot(new Vector3d(0,0,8.5),"my robot"));
    }
