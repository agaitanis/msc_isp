...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BehaviorBasedAgent bug0 = new BehaviorBasedAgent(new Vector3d(0,0,8), "Bug0", 8, false);
        Sensors sensors = bug0.getSensors();
        Behavior[] behaviors = { new ReachGoal(sensors,bug0,goal),
            new MoveToGoal(sensors,bug0,goal), new CircumNavigate(sensors,bug0,goal,true)};
        boolean subsumes[][] = { { false, true,  true},
                                 { false, false, true},
                                 { false, false, false}};
        bug0.initBehaviors(behaviors, subsumes);
        environment.add(bug0);
